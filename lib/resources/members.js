...
class Members {
  ...
  project(projectId) {
    ...
    return this.connection(utils.format('/projects/%s/members', encodeURIComponent(projectId)));
  }
  ...
  group(groupId) {
    ...
    return this.connection(utils.format('/groups/%s/members', encodeURIComponent(groupId)));
  }
}
